...
public interface UserApiSpec {
    ...
    ResponseEntity<PointDto.Response> chargePoint(@PathVariable("userId") @Valid UserId userId, @RequestBody PointDto.ChargeRequest request);
    ...
    ResponseEntity<PointDto.Response> usePoint(@PathVariable("userId") @Valid UserId userId, @RequestBody PointDto.UseRequest request);
